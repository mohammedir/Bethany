...
<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
    ...
    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
        ...
        <div class="menu-item">
            ...
            <div class="menu-item">
                <a class="menu-link {{$url == url("/admin/dashboard")? "active":""}}" href="{{url("/admin/dashboard")}}">
            ...
            <div data-kt-menu-trigger="click"
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{$url == url("/admin/admins") ? "active":""}}"
                               href="{{url("/admin/admins")}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                <span class="menu-title">{{__('str.Admins')}}</span>
                            </a>
                        </div>
                        <div class="menu-item">
        ...
        <div data-kt-menu-trigger="click"
             class="menu-item menu-accordion {{str_contains($url,"form") ? "hover show":""}} ">
									<span class="menu-link {{str_contains($url,"form") ? "active":""}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen051.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                    <a class="menu-link {{str_contains($url,"places") ? "active":""}}" href="{{url("admin/places")}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
