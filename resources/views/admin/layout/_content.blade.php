    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__("str.")}} {{__("str.Dashboard")}}</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            <!--begin::Actions-->
            <div class="d-flex align-items-center gap-2 gap-lg-3 d-none">
                <!--begin::Secondary button-->
                    ...
                    <a href="{{url("/admin/orders")}}" class="btn btn-sm btn-light">{{__("str.Manage Orders")}}</a>

            <!--end::Secondary button-->
                <!--begin::Primary button-->

                    <a href="{{url("/admin/products/create")}}"
                       class="btn btn-sm btn-primary">{{__("str.Add Product")}}</a>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-xl-10">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                    ...
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center h-md-50 mb-5 mb-xl-10" style="background-color: #080655;background-image:url('/metronic8/demo1/assets/media/svg/shapes/wave-bg-dark.svg')">
                        <!--begin::Header-->
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-toolbar d-none">
                                ...
                                <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" class="btn btn-sm btn-light d-flex align-items-center px-4">
                                    <!--begin::Display range-->
                                    <div class="text-gray-600 fw-bolder">1 Mar 2022 - 30 Mar 2022</div>
                                    <!--end::Display range-->
                ...
                <div class="col-lg-12 col-xl-12 col-xxl-6 mb-5 mb-xl-0">
                    ...
                    <div class="card card-flush d-none h-md-100">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Select-->
                                <select name="status" data-control="select2" data-hide-search="true" class="form-select form-select-solid form-select-sm fw-bolder w-100px select2-hidden-accessible" data-select2-id="select2-data-7-n3kb" tabindex="-1" aria-hidden="true">
                                    <option value="1" selected="selected" data-select2-id="select2-data-9-41ab">Options</option>
                                    <option value="2">Option 1</option>
                                    <option value="3">Option 2</option>
                                    <option value="4">Option 3</option>
                                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-1-adkc" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid form-select-sm fw-bolder w-100px" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false" aria-labelledby="select2-status-3l-container" aria-controls="select2-status-3l-container"><span class="select2-selection__rendered" id="select2-status-3l-container" role="textbox" aria-readonly="true" title="Options">Options</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-42b8" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid form-select-sm fw-bolder w-100px" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-status-nq-container" aria-controls="select2-status-nq-container"><span class="select2-selection__rendered" id="select2-status-nq-container" role="textbox" aria-readonly="true" title="Options">Options</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                <!--end::Select-->
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        ...
                        <div class="card-body py-9">
                            ...
                            <div class="row gx-9 h-100">
                                ...
                                <div class="col-sm-6 mb-10 mb-sm-0">
                                    <!--begin::Image-->
                                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('/metronic8/demo1/assets/media/stock/600x600/img-33.jpg');"></div>
                                    <!--end::Image-->
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-sm-6">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                                                    ...
                                                    <span class="fs-6 text-gray-700 fw-bolder">$
																		<span class="ms-n1 counted" data-kt-countup="true" data-kt-countup-value="284,900.00">284,900</span></span>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
                                        ...
                                        <div class="d-flex flex-stack mt-auto bd-highlight">
                                            ...
                                            <!--end::Users group-->
                                            <!--begin::Actions-->
                                            <a href="/metronic8/demo1/../demo1/apps/projects/project.html" class="text-primary opacity-75-hover fs-6 fw-bold">View Project
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center h-100">
                                ...
                                <div class="col-5 pt-10">
                                    <!--begin::Illustration-->
                                    <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px" style="background-image:url('/metronic8/demo1/assets/media/svg/illustrations/easy/5.svg');"></div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Col-->
                            </div>
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <!--end::Title-->
                                <!--begin::Illustration-->
                                <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12" style="background-image:url('/metronic8/demo1/assets/media/svg/illustrations/easy/2.svg')"></div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Links-->
                            <div class="text-center mb-1">
                                ...
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="/metronic8/demo1/../demo1/apps/user-management/users/view.html">Learn More</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-4-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_4_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo1/assets/media/"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
                                ...
                                <div class="tab-pane" id="kt_timeline_widget_4_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-4-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_4_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo1/assets/media/"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
                                ...
                                <div class="tab-pane" id="kt_timeline_widget_4_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-4-blockui="true">
                                    <div class="table-responsive pb-10">
                                        <!--begin::Timeline-->
                                        <div id="kt_timeline_widget_4_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/metronic8/demo1/assets/media/"></div>
                                        <!--end::Timeline-->
                                    </div>
                                </div>
                                <!--end::Tab pane-->
