                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="row card-body pt-0 pb-0">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select id="selector" name="selector" class="form-select form-select-solid"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <div class="form-control form-control-solid">
                                        ...
                                        <div class="d-flex flex-column fv-row">
                                            <div class="row">
                                                <!--begin::Radio-->
                                                <div class="col-6 form-check form-check-custom form-check-solid mb-5">
                                                    <!--begin::Input-->
