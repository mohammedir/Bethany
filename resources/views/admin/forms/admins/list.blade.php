...
@section('title',__("str.Admins list"))
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__('str.Admins list')}}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">{{__('str.Admins list')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div id="filter_perant" class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <a id="reset" class="btn btn-light-danger">
                                ...
                                <a href="{{url("/admin/places/create")}}"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_forms_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-start ps-2">{{__('str.Mobile')}}</th>
                                <th class="text-center">{{__('str.Email')}}</th>
                                <th class="text-center">{{__('str.Address')}}</th>
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/forms/admins/list.js') }}" defer></script>
@endsection
