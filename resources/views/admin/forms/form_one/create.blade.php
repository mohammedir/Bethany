        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div id="kt_ecommerce_edit_form" class="form d-flex flex-column flex-lg-row"
                     data-kt-redirect="">
                    <!--begin::Main column-->
                    <form id="my_form" method="post" action="{{env("APP_URL") . "/admin/form_one/store"}}"  class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        @csrf
                            ...
                            <div class="row card-body pt-0 pb-0">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <div class="input-group">
                                        <input name="date_of_birth" id="date_of_birth"
                                               class="auto_date date_of_birth form-control form-control-solid mb-3 mb-lg-0"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <input id="age" type="number" name="age"
                                           class="auto_age required text-start form-control form-control-solid mb-3 mb-lg-0"
                                           placeholder="{{__("str.Enter Here")}}"
                                           value=""/>
                                    <!--end::Input-->
                                    <!--begin::Error-->
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <!--end::Select2-->
                                    <!--begin::Error-->
                                    <strong id="form_one_disability_type_cd_error" class="errors text-danger fs-7"></strong>
                                    <!--end::Error-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-12 mb-10">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea rows="4" id="notes" type="text"
                                                  name="notes"
                                                  class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <div id="kt_docs_repeater_advanced" class="card card-flush py-4">
                                    ...
                                    <div class="row card-body pt-0 pb-0">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-2 mb-10">
                                            ...
                                            <div class="input-group">
                                                <input name="form_two_date_of_birth"
                                                       class="form_two_auto_date form_two_date_of_birth form-control form-control-solid mb-3 mb-lg-0"
                                                       data-kt-repeater="datepicker"
                                                       placeholder="@lang("str.Pick a date")"/>
                                                <span class="input-group-text border-0"><i
                                                            class="text-dark la la-calendar"></i></span>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-2 mb-10">
                                            ...
                                            <input type="number" name="form_two_age"
                                                   class="form_two_auto_age form_two_age required text-start form-control form-control-solid mb-3 mb-lg-0"
                                                   placeholder="{{__("str.Enter Here")}}"
                                                   value=""/>
                                            <!--end::Input-->
                                            <!--begin::Error-->
                                        ...
                                        <!--end::Input group-->
                                        <div class="text-center col-sm-12 col-md-6 col-lg-1 mb-10">
                                            <a data-repeater-delete
                                               class="delete_button btn btn-sm btn-light-danger mt-3 mt-md-9">
                                                <i class="la la-trash-o fs-3 m-0 p-0"></i>
                                            </a>
                                        </div>
                                        <div class="separator col-sm-12 col-md-12 col-lg-12 mb-5"></div>
                                    </div>
                                </div>
                            </div>
                            <!--begin::Error-->
                            ...
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="card-footer mt-0 pt-0 mb-3">
                                <a href="javascript:;" data-repeater-create class="btn btn-primary" type="button">
                                    <i class="la la-plus"></i>@lang("str.Add More")
                                </a>
                            </div>
                            <!--end::Form group-->
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="row card-body pt-0">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <p class="form-control form-control-solid mb-3 mb-lg-0">{{auth()->guard("admin")->user()->name}}</p>
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/forms/form_one/create.js') }}" defer></script>
@endsection
