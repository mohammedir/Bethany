        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div id="kt_ecommerce_edit_form" class="form d-flex flex-column flex-lg-row"
                     data-kt-redirect="">
                    <!--begin::Main column-->
                    <form id="my_form" method="post" action="{{env("APP_URL") . "/admin/form_one/update/".$form->individual_id}}" class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    @csrf
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/forms/form_one/edit.js') }}" defer></script>
@endsection
